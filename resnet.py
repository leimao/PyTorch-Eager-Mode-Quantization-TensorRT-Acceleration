# resnet.py
# Modified from
# https://github.com/pytorch/vision/blob/v0.18.0/torchvision/models/resnet.py
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.fc = nn.Conv2d(512 * block.expansion,
                            num_classes,
                            kernel_size=1,
                            stride=1,
                            padding=0,
    ...
    IMAGENET1K_V2 = Weights(
        ...
        meta={
            **_COMMON_META,
            ...
            44549160,
            "recipe":
            "https://github.com/pytorch/vision/issues/3995#new-recipe",
            "_metrics": {
                "ImageNet-1K": {
                    "acc@1": 81.886,
                    "acc@5": 95.780,
    ...
    IMAGENET1K_V2 = Weights(
        ...
        meta={
            **_COMMON_META,
            ...
            88791336,
            "recipe":
            "https://github.com/pytorch/vision/issues/3995#new-recipe-with-fixres",
            "_metrics": {
                "ImageNet-1K": {
                    "acc@1": 82.834,
                    "acc@5": 96.228,
    ...
    IMAGENET1K_V1 = Weights(
        ...
        meta={
            **_COMMON_META,
            ...
            83455272,
            "recipe":
            "https://github.com/pytorch/vision/pull/5935",
            "_metrics": {
                "ImageNet-1K": {
                    "acc@1": 83.246,
                    "acc@5": 96.454,
    ...
    IMAGENET1K_V1 = Weights(
        ...
        meta={
            **_COMMON_META,
            ...
            68883240,
            "recipe":
            "https://github.com/pytorch/vision/pull/912#issue-445437439",
            "_metrics": {
                "ImageNet-1K": {
                    "acc@1": 78.468,
                    "acc@5": 94.086,
